...
function saveValues() {
  ...
  var conf = 0;
  var onoff1;
  if (document.getElementById("onoff").checked) onoff1 = 1;
  else onoff1 = 0;
  ...
  window.localStorage.setItem("AutoJoomerOnoff", JSON.stringify(onoff1));
}
...
function populator() {
  ...
  if (JSON.parse(window.localStorage.getItem("AutoJoomerUsername")) != null)
    username.value = JSON.parse(
      window.localStorage.getItem("AutoJoomerUsername")
    );
  if (JSON.parse(window.localStorage.getItem("AutoJoomerPassword")) != null)
    password.value = JSON.parse(
      window.localStorage.getItem("AutoJoomerPassword")
    );
  ...
  if (JSON.parse(window.localStorage.getItem("AutoJoomerOnoff")) == 1)
    onoff.checked = true;
  if (JSON.parse(window.localStorage.getItem("AutoJoomerOnoff")) == 0)
    onoff.checked = false;
}
